...
const STEPS = [
  {
    ...
    title: 'Egnach in deiner Hand.',
    text: 'Entdecke Anlässe der Gemeinde und Vereine, leihe vom Nachbarn, biete deine Hilfe an — alles an einem Ort.',
    tone: 'primary',
  },
  {
    badge: 'SCHRITT 2 VON 3',
    title: 'Der Marktplatz der Nachbarschaft.',
    text: 'Leihe Werkzeuge, biete Dienste an, tausche Gartenprodukte — direkt mit verifizierten Nachbarn aus Egnach.',
    tone: 'accent',
  },
  {
    badge: 'SCHRITT 3 VON 3',
    title: 'Verbunden, auch über Sprachen hinaus.',
    text: 'Chat mit automatischer Übersetzung in DE, EN, IT, SQ und TR. Niemand bleibt ausgeschlossen.',
    tone: 'success',
  },
];
    ...
    <Screen background="var(--surface)">
      ...
      <div style={{ flex: 1, padding: '14px 28px 0', display: 'flex', flexDirection: 'column', gap: 24, overflow: 'hidden' }}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Badge tone={STEPS[step].tone} size="sm">{STEPS[step].badge}</Badge>
      ...
      <div style={{ padding: '18px 24px 28px', display: 'flex', flexDirection: 'column', gap: 16, flexShrink: 0 }}>
        <Dots count={3} active={step} accent="var(--primary)" />
        <Button
          full size="lg"
