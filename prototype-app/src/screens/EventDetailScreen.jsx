...
import { Screen, Body, HelpSheet, Toast, ReportSheet } from '../components/index.js';
  ...
  return (
    <Screen background="var(--surface)" style={{ overflowY: 'auto' }}>
      ...
      <ReportSheet
        ...
        title="Anlass melden"
        onSubmit={({ reason, note }) => actions.submitReport({ type: 'event', refId: event.id, reason, note })}
      />
    </Screen>
  );
}
